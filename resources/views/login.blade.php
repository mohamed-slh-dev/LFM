...
<html lang="ar">
    ...
    <body class="account-body accountbg">
                ...
                <div class="col-3">
                    <li class="hidden-sm pt-3" style="list-style-type: none;">
                        <a class="nav-link dropdown-toggle waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            ...
                            اللغة <img src="{{asset('assets/images/flags/UAE_flag.jpg')}}" class="mx-2" height="16" alt=""/> <i class="mdi mdi-chevron-down"></i> 
                        ...
                        <div class="card-body ">
                            ...
                            <div class="px-3">
                                ...
                                <div class="text-center auth-logo-text">
                                    <h2 class="mt-0 mb-3 " style="color: #2b1c19; font-weight:bold;">مرحبا بك </h2>
                                    <p class=" mb-0" style="color: #2b1c19; font-weight:bold; "> ابدأ العمل</p>  
                                ...
                                <form class="form-horizontal auth-form my-4" method="POST" action="{{ route('login_') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="username" style="color: #2b1c19; font-weight:bold;">البريدالألكتروني</label>
                                    ...
                                    <div class="form-group">
                                        <label for="userpassword" style="color: #2b1c19; font-weight:bold;">كلمة المرور</label>                                            
                                        <div class="input-group mb-3"> 
        ...
        <h4 class="text-center" style="color: black"> <span style=""> <a href="http://truth.ae" target="_blank">
