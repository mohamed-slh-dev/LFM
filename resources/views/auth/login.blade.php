                        ...
                        <div class="card-body">
                            ...
                            <div class="px-3">
                                ...
                                <div class="text-center auth-logo-text">
                                    <h4 class="mt-0 mb-3 ">مرحبا بك </h4>
                                    <p class=" mb-0" style="color: #0f0f0f "> ابدأ العمل</p>  
                                ...
                                <form class="form-horizontal auth-form my-4" method="POST" action="{{ route('login_') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="username" style="color: #000000;">البريدالألكتروني</label>
                                    ...
                                    <div class="form-group">
                                        <label for="userpassword" style="color: #000000;">كلمة المرور</label>                                            
                                        <div class="input-group mb-3"> 
