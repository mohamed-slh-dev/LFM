                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                  ...
                                  <td>{{$decision_noti->N_CASE_ID}}</td>
                                        ...
                                        <td>{{ \Carbon\Carbon::parse($decision_noti->DT_HearingEnterDate)->addDays($decision_noti->N_Period) }}</td>
...
<script>
    ...
    document.getElementById("breadcrumb-2").innerHTML = "تنبيهات الاحكام"; 

    document.getElementById("page-name").innerHTML = "تنبيهات الاحكام";
      }else{
        document.body.style.direction = "ltr"; 
    document.body.style.textAlign = "left"; 
    document.getElementById("breadcrumb-float").classList.add('float-right');
    document.getElementById("breadcrumb-2").innerHTML = "notifications";
    document.getElementById("breadcrumb-1").innerHTML = "judgments alert";


    document.getElementById("page-name").innerHTML = "Judgments alert";
