        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form"  method="POST" action="{{route('add-specific-task')}}">
                        @csrf
...
<script>
  if (lang == "ar") {
    ...
    document.getElementById("breadcrumb-2").innerHTML = "المهام الخاصة"; 

    document.getElementById("page-name").innerHTML = "المهام الخاصة";
    ...
    document.getElementById("breadcrumb-1").innerHTML = "specific tasks" ;


    document.getElementById("page-name").innerHTML = "SPECIFIC TASKS";
