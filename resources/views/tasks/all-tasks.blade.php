...
<script>
  if (lang == "ar") {
    ...
    document.getElementById("breadcrumb-2").innerHTML = "جميع المهام"; 

    document.getElementById("page-name").innerHTML = "جميع المهام";
    ...
    document.getElementById("breadcrumb-1").innerHTML = "all tasks" ;


    document.getElementById("page-name").innerHTML = "ALL TASKS";
