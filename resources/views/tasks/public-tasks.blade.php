        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form"  method="POST" action="{{route('add-public-task')}}">
                        @csrf
...
<script>
  if (lang == "ar") {
    ...
    document.getElementById("breadcrumb-2").innerHTML = "المهام العامة"; 

    document.getElementById("page-name").innerHTML = "المهام العامة";
    ...
    document.getElementById("breadcrumb-1").innerHTML = "public tasks" ;


    document.getElementById("page-name").innerHTML = "PUBLIC TASKS";
