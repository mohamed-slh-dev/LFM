        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form"  method="POST" action="{{route('add-adminstrative-task')}}">
                        @csrf
...
<script>
  if (lang == "ar") {
    ...
    document.getElementById("breadcrumb-2").innerHTML = "المهام الادارية"; 

    document.getElementById("page-name").innerHTML = "المهام الادارية";
    ...
    document.getElementById("breadcrumb-1").innerHTML = "adminstrative tasks" ;


    document.getElementById("page-name").innerHTML = "ADMINSTRATIVE TASKS";
