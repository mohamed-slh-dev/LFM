                    ...
                    <div class="col-12"> 
                        <div class="form-group row">
                                   ...
                                   <div class="col-sm-4">
                                      ...
                                      <input class="form-control"  name="case_uid" value="{{$case_details->S_CASE_UID}}" type="text" id="example-text-input">
                                  </div>
                ...
                <div class="col-12"> 
                             ...
                             <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-4">
                                     <label  id="stage-register-date">تاريخ التسجيل </label>
                                        <input class="form-control" value="{{$case_details->registerDate}}" name="rigster_case_date" type="date" id="example-text-input">
                                  </div>
                   ...
                   <div class="col-12"> 
                              ...
                              <select class="custom-select" name="expert">
                                  ...
                                  <div class="col-sm-4">
                                    <label id="stage-fees"></label>
                                       <input class="form-control fraction-commas"  name="fee" value="{{$case_details->S_COURT_FEES}}" type="text" id="example-text-input">
                          </div>
                      ...
                      <div class="col-12"> 
                       ...
                       <div class="col-12"> 
                        <button type="submit" class="btn btn-sm btn-primary mr-1 font-15" id="add-new-stage-btn">إضافة دعوى</button>
                      </div> 
...
<script>
    ...
    document.getElementById("breadcrumb-2").innerHTML = '<a href="{{url('main-case-cases/'.$case_details->N_CASE_ID)}}">القضية {{$case_details->N_CASE_ID}} </a>'; 
    ...
    document.getElementById("add-new-stage-btn").innerHTML = "تحديث الدعوى ";
        }else{
          document.body.style.direction = "ltr"; 
    document.body.style.textAlign = "left"; 
    document.getElementById("breadcrumb-float").classList.add('float-right');
    document.getElementById("breadcrumb-3").innerHTML =  "cases manage"; 
    document.getElementById("breadcrumb-2").innerHTML = '<a href="{{url('main-case-cases/'.$case_details->N_CASE_ID)}}">case {{$case_details->N_CASE_ID}} </a>' ;
    ...
    document.getElementById("add-new-stage-btn").innerHTML = "Update stage ";
        }
</script>
