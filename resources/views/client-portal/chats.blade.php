    ...
    <div class="col-12">
                ...
                <div class="tab-pane fade show active" id="general_chat">
                    ...
                    <div class="media new-message">
                        <div class="media-left">
                            <img src="{{asset('assets/images/users/user-2.jpg')}}" alt="user" class="rounded-circle thumb-md">
        ...
        <div class="chat-box-right" id="chat-box">
            ...
            <div class="chat-footer">
                <form class="form"  method="POST" action="{{route('add-client-message')}}">
                    @csrf
                <input type="hidden" name="chat_id" value="{{$chat_id}}">
                <div class="row">                                                    
                    <div class=" col-10">
                        <span class="chat-admin"><img src="{{asset('assets/images/clients-imgs/'.Session::get('client_pic'))}}" alt="user" class="rounded-circle thumb-sm"></span>
