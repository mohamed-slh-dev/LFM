                    ...
                    <div class="row">
                       ...
                       @endif
                            ...
                            <ul class="list-unstyled personal-detail">
                                <li class=""><b><i class="dripicons-phone  text-info font-18"></i> <span id="phone"> </span> </b> {{$about->phone}} </li>
                                <li class="mt-2"><b> <i class="dripicons-mail text-info font-18 mt-2 "></i> <span id="mail"></span> </b>  {{$about->email}} </li>
                                <li class="mt-2"><b> <i class="dripicons-location text-info font-18 mt-2 "></i> <span id="address"></span> </b>  {{$about->address}} </li>
                            </ul>
...
<script>
    ...
    document.getElementById("cases-number").innerHTML = " القضايا";
    ...
    document.getElementById("worked-years").innerHTML = "Work Experience ";
    document.getElementById("cases-number").innerHTML = " Cases";
